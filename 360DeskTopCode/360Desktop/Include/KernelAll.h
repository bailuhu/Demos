...
struct __declspec(uuid("bca49011-c0e0-4a87-943e-4ce1325a6e94")) IDUIPopupSingleList : IDUIControlBase
{
	...
	//Method Wrapper
	//
	long  AddItem(tstring  strName, tstring  strText, tstring  strShortcut, long  nImageIndex  );
	long  InsertItem(long  nIndex, tstring  strName, tstring  strText, tstring  strShortcut, long  nImageIndex  );
...
struct __declspec(uuid("b260d36a-f8bc-4063-9803-04f10cc50caf")) IDUIEditCtrl : IDUIControlBase
{
	...
	long  LineIndex(long  nLine  );
	long  LineLength(long  nLine  );
	void LineScroll(long  nLines, long  nChars  );
	void ReplaceSel(tstring  strNewText, BOOL  bCanUndo  );
	void SetPasswordChar(signed char  ch  );
	void SetEditRect(struct SkinRect * pRect  );
	void SetEditRectNP(struct SkinRect * pRect  );
	void SetSelByFlage(unsigned long  dwSelection, BOOL  bNoScroll  );
	...
	BOOL  CanPaste(unsigned long  nFormat  );
	...
	long  GetTextLength();
	long  GetTextLengthEx(unsigned long  ulFlags, unsigned long  uCodePage  );
	...
	long  FormatRange(struct DUIEDIT_FORMATRANGE * pFR, BOOL  bDisplay  );
	void HideSelection(BOOL  bHide, BOOL  bPerm  );
	void PasteSpecial(unsigned long  nClipFormat, unsigned long  dvAspect, OLE_HANDLE  hMF  );
	void RequestResize();
...
struct __declspec(uuid("333ac87d-148e-4985-9ac9-b68bec61fd03")) IDUIScrollBar : IDUIControlBase
{
	...
	//
	long  GetScrollPos();
	long  SetScrollPos(long  nPos, BOOL  bRedraw  );
	void GetScrollRange(long * lpMin, long * lpMax  );
	void SetScrollRange(long  nMin, long  nMax, BOOL  bRedraw  );
	void ShowScrollBar(BOOL  bShow  );
	void EnableScrollBar(BOOL  bEnabled  );
	BOOL  SetScrollInfo(struct DUISCROLLINFO * lpScrollInfo, BOOL  bRedraw  );
	BOOL  GetScrollInfo(struct DUISCROLLINFO * lpScrollInfo, enum DUISB_MASK  sifMask  );
	long  GetScrollLimit();
...
struct __declspec(uuid("e44fad6d-9cf1-40ba-a229-206dd2775354")) IDUIToolBarButton : IDUIToolBarItemBase
{
	...
	OLE_HANDLE  GetGraphic();
	void SetState(enum DUI_TBITEM_STATE  eState, BOOL  bRedraw  );
	enum DUI_TBITEM_STATE  GetState();
	void SetTooltip(tstring  strTooltip  );
	tstring  GetTooltip();
