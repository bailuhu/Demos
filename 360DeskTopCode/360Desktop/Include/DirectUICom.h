#ifndef __HEAD__DIRECTUICOM__
#define __HEAD__DIRECTUICOM__
#include <comdef.h>
...
struct __declspec(uuid("932cf3c4-9cff-42b9-8fe7-0e246e888eab")) IDUIObj : IDispatch
{
	...
	virtual HRESULT __stdcall raw_SetObjPtr(long pObjPtr  ) = 0;
	virtual HRESULT __stdcall raw_GetObjPtr(long *pResult) = 0;
	...
	CString  GetTypeName();
	void SetTypeName(CString  strTypeName  );
...
struct __declspec(uuid("936c7adf-65af-4807-8434-474243ddeb26")) ISkinObjResBase : IDUIObj
{
	...
	virtual HRESULT __stdcall raw_GetWindow(long *pResult) = 0;
	virtual HRESULT __stdcall raw_SetOwnerHwnd(long lhWnd  ) = 0;
	virtual HRESULT __stdcall raw_SetDirectUIHwnd(long lhWnd  ) = 0;
	...
	short  GetChildCount();
	struct ISkinObjResBase * GetSubCaptionObject(CString  strCaption, short * pnIndex  );
	struct ISkinObjResBase * GetSubResObject(struct ISkinObjResBase * pObj, short * pnIndex  );
	struct ISkinObjResBase * GetObjectByCaption(long  lType, CString  strName, BOOL  bDeep  );
	...
	long  GetWindow();
	void SetOwnerHwnd(long  lhWnd  );
	void SetDirectUIHwnd(long  lhWnd  );
...
struct __declspec(uuid("d0ab9acc-2c46-4198-a091-54e117e9677c")) ISkinShareBase : IDUIObj
{
	...
	virtual HRESULT __stdcall raw_GetSharePtr(long *pResult) = 0;
	...
	BOOL  AccessConfig2(OLE_HANDLE  pXmlEle, CString  strKeyName, BOOL  bRead, BOOL  bCompleteUseKey  );
...
struct __declspec(uuid("ab375056-06b6-4507-8e67-2cffebc44ffc")) ISkinWithRealResBase : ISkinShareBase
{
	...
	//Method Wrapper
	//
	BOOL  ImportFile(CString  strFile  );
	BOOL  ExportFile(CString  strFile  );
...
struct __declspec(uuid("f0a6b880-d1d3-4f9e-9e06-ba340130a26d")) IDUIRes : IDispatch
{
	...
	virtual HRESULT __stdcall raw_CreateDirectUI(BSTR strName, long hWndParent, IDispatch **pResult) = 0;
	...
	virtual HRESULT __stdcall raw_GetComDispatch(long pDUIObj, struct IDUIObj **pResult) = 0;
	virtual HRESULT __stdcall raw_GetResObjectByGuid(enum DUIObjType eType, BSTR strGuid, struct IDUIObj **pResult) = 0;
	virtual HRESULT __stdcall raw_RemoveObject(long pDUIObj, VARIANT_BOOL bRelease, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_AddScriptObjects(long pScriptObject, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_SetDUIResObjPtr(long lResObjPtr  ) = 0;
	virtual HRESULT __stdcall raw_GetDUIResObjPtr(long *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_EnumObjectsToCallback(enum DUIObjType objType, OLE_HANDLE pFunCallback, long nParam  ) = 0;
	...
	virtual HRESULT __stdcall raw_CallNextKBHook(long nCode, long wParam, long lParam, long *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_GetObjectFromLong(long nObject, struct IDUIObj **pResult) = 0;
	...
	virtual HRESULT __stdcall raw_AddStrProp(BSTR strKey, BSTR strValue, long pStrProp  ) = 0;
	virtual HRESULT __stdcall raw_RemoveStrProp(BSTR strKey, long pStrProp  ) = 0;
	...
	//Method Wrapper
	//
	BOOL  OpenSkin(CString  strSkinPath, CString  strSknPath, BOOL  bSkinCtrls  );
	BOOL  CloseSkin();
	IDispatch * CreateDirectUI(CString  strName, long  hWndParent  );
	IDispatch * GetDirectUIForm(CString  strName  );
	struct IDUIObj * GetResObject(enum DUIObjType  eType, CString  strName, struct ISkinObjResBase * pObjParent, BOOL  bDeep  );
	struct IDUIImageBase * GetImageBaseFromFile(CString  strFilePath  );
	struct IDUIEvents * GetEventHandle();
	struct IDUIObj * GetComDispatch(long  pDUIObj  );
	struct IDUIObj * GetResObjectByGuid(enum DUIObjType  eType, CString  strGuid  );
	BOOL  RemoveObject(long  pDUIObj, BOOL  bRelease  );
	BOOL  AddScriptObjects(long  pScriptObject  );
	BOOL  IsDesignStatus();
	OLE_HANDLE  DrawImageSection(struct SkinRect  rect, struct IDUIImageBase * pImageSection  );
	OLE_HANDLE  DrawTextStyle(struct SkinRect  rect, CString  strText, struct IDUITextStyle * pTextStyle  );
	BOOL  AccessAttribRect(OLE_HANDLE  pXmlEle, CString  strAttribName, struct SkinRect * prcValue, BOOL  bRead  );
	BOOL  AccessAttribSize(OLE_HANDLE  pXmlEle, CString  strAttribName, struct SkinSize * psizeValue, BOOL  bRead  );
	BOOL  AccessAttribLong(OLE_HANDLE  pXmlEle, CString  strAttribName, long * plValue, BOOL  bRead  );
	BOOL  AccessAttribFloat(OLE_HANDLE  pXmlEle, CString  strAttribName, float * pfValue, BOOL  bRead  );
	BOOL  AccessAttribDouble(OLE_HANDLE  pXmlEle, CString  strAttribName, double * pdValue, BOOL  bRead  );
	BOOL  AccessAttribBOOL(OLE_HANDLE  pXmlEle, CString  strAttribName, VARIANT_BOOL * pbValue, BOOL  bRead  );
	BOOL  AccessAttribString(OLE_HANDLE  pXmlEle, CString  strAttribName, BSTR * pstrValue, BOOL  bRead  );
	BOOL  AccessAttribColor(OLE_HANDLE  pXmlEle, CString  strAttribName, OLE_COLOR * pclrValue, BOOL  bRead  );
	BOOL  GradientFill(OLE_HANDLE  hDC, struct SkinRect  rect, OLE_COLOR  clrFrom, OLE_COLOR  clrTo, long  nIrotation  );
	void SetDUIResObjPtr(long  lResObjPtr  );
	long  GetDUIResObjPtr();
	long  CreateDUIResObj();
	BOOL  CloseDUIResObj();
	struct IDUIControlBase * ImportSkin(OLE_HANDLE  hInstance, long  uResID, CString  strResSec, OLE_HANDLE  hObjParent  );
	...
	void EnumObjectsToCallback(enum DUIObjType  objType, OLE_HANDLE  pFunCallback, long  nParam  );
	struct IDUIObj * AddResObject(enum DUIObjType  objType, struct IDUIObj * pOwnerObj, CString  strName, BOOL  bInsertFirst  );
	...
	struct IDUIControlBase * AddPluginResObject(struct IDUIObj * pOwnerObj, CString  strName, CString  strGuid  );
	BOOL  DrawIcon(OLE_HANDLE  hDC, short  xLeft, short  yTop, short  cxWidth, short  cyHeight, OLE_HANDLE  hIcon  );
	enum DUIObjType  ConvertINameToType(CString  bstrInterfaceName  );
	CString  ConvertTypeToIName(enum DUIObjType  eType  );
	BOOL  Save(CString  bstrPath  );
	BOOL  SetDesignStatus(BOOL  bDesign  );
	CString  GetSkinFilePath();
	...
	struct IDUIImageList * GetImageListFromFile(CString  strFilePath, short  cx, OLE_COLOR  crMask  );
	void ReleasePluginResObject(struct IDUIControlBase * pPlugin  );
	struct IDUIControlBase * CreatePluginResObject(CString  strGuid  );
	...
	long  CallNextKBHook(long  nCode, long  wParam, long  lParam  );
	...
	BOOL  StartHook();
	BOOL  EndHook();
	struct IDUIObj * GetObjectFromLong(long  nObject  );
	struct IDUIWindow * GetDUIWindow();
	void ChangeSkn(CString  strSkinPath, VARIANT_BOOL * pbResult  );
	void OpenTheme(CString  strSkinPath, VARIANT_BOOL * pbResult  );
	void ExportSknDuiFile(CString  strSkinPath, VARIANT_BOOL * pbResult  );
	struct IDUIControlBase * AddPluginResObject2(struct IDUIObj * pOwnerObj, CString  strName, CString  strGuid, BOOL  bIsComposeCtrl  );
	BOOL  AccessAttribString2(CString  strAttribName, BSTR * pstrValue, BOOL  bRead  );
	void AddStrProp(CString  strKey, CString  strValue, long  pStrProp  );
	void RemoveStrProp(CString  strKey, long  pStrProp  );
	void ChangeLanguage(enum DUI_LANGUAGE  eLang  );
	long  GetCurAllLang(enum DUI_LANGUAGE * peLang, long  eLangSize  );
	void GenerateLanguageXML(CString  strXMLPath  );
...
struct __declspec(uuid("1d0ecc68-0eac-4ff3-a0c7-6d2636c6d6ac")) IDUIImageBase : ISkinShareBase
{
	...
	virtual HRESULT __stdcall raw_GetWidth(long *pResult) = 0;
	virtual HRESULT __stdcall raw_GetHeight(long *pResult) = 0;
	virtual HRESULT __stdcall raw_CreateImageSection(BSTR strSectionName, long pDUIRes, VARIANT_BOOL *pResult) = 0;
	...
	long  GetWidth();
	long  GetHeight();
	BOOL  CreateImageSection(CString  strSectionName, long  pDUIRes  );
...
struct __declspec(uuid("118c0877-b832-4c18-bfbf-7a112483b6af")) IDUITextStyle : ISkinShareBase
{
	...
	virtual HRESULT __stdcall raw_CreateTextStyle(BSTR strTextStyleName, long pDUIRes, VARIANT_BOOL *pResult) = 0;
	...
	BOOL  DrawText(OLE_HANDLE  hDC, CString  strText, struct SkinRect  rect, BOOL  bCalcDraw, long  nUserFormat, struct SkinRect * pRectCalc  );
	long  GetDrawFlags();
	BOOL  CreateTextStyle(CString  strTextStyleName, long  pDUIRes  );
};
...
struct __declspec(uuid("b143f497-cdec-4a2f-b903-530228d4bdb1")) IDUIControlBase : ISkinObjResBase
{
	...
	virtual HRESULT __stdcall raw_DirectRedraw() = 0;
	...
	virtual HRESULT __stdcall raw_GetPropList(long *pPropList  ) = 0;
	...
	virtual HRESULT __stdcall raw_CreateObj(long pSkinResource, long pObjParent, long ntype, VARIANT_BOOL bInsertFirst, long *pResult) = 0;
	virtual HRESULT __stdcall raw_DrawPreview(long hDC, struct SkinRect *sknrc  ) = 0;
	virtual HRESULT __stdcall raw_FinalCreate(VARIANT_BOOL bNewObject  ) = 0;
	virtual HRESULT __stdcall raw_GetInerface(long pIID, IDispatch **pResult) = 0;
	...
	virtual HRESULT __stdcall raw_CallMsg(long nMsgID, long wParam, long lParam, VARIANT_BOOL *pResult) = 0;
	...
	void DirectRedraw();
	CString  CallProp(long  lPropId  );
	void AddProp(struct ICtrlPluginProp * pProp  );
	void GetPropList(long * pPropList  );
	void Load();
	...
	long  CreateObj(long  pSkinResource, long  pObjParent, long  ntype, BOOL  bInsertFirst  );
	void DrawPreview(long  hDC, struct SkinRect * sknrc  );
	void FinalCreate(BOOL  bNewObject  );
	IDispatch * GetInerface(long  pIID  );
	...
	struct ICtrlPluginProp * CreateGroupProp(struct ICtrlPluginProp * pParentProp, CString  strPropName, BOOL  bExpand  );
	struct IDUIPropBase * CreateProp(struct ICtrlPluginProp * pPropParent, enum enumPropType  eType, CString  strPropName, CString  strPropHelp, BOOL  bIsStyle, struct IPropChangedCallback * pCallback  );
	BOOL  ExportConfig(OLE_HANDLE  pXmlEle  );
	...
	BOOL  CallMsg(long  nMsgID, long  wParam, long  lParam  );
...
struct __declspec(uuid("86d01378-75ad-42fc-8f3b-99f796d89a18")) IDUIObjectDraw : IDispatch
{
	...
	BOOL  DrawText(struct IDUITextStyle * pTextStyle, CString  strText  );
	BOOL  Blend();
	OLE_HANDLE  GetBmpBits();
	BOOL  SaveBitmap(CString  strImagePath  );
};
...
struct __declspec(uuid("9b178567-37f3-4229-8286-234217f0a2fa")) ICtrlPluginProp : IDispatch
{
	...
	BOOL  ExportConfig(CString  strParentName, OLE_HANDLE  pXmlEle  );
	...
	BOOL  AccessConfig2(CString  strParentName, OLE_HANDLE  pXmlEle, BOOL  bRead  );
	...
	BOOL  AccessConfig3(CString  strParentName, OLE_HANDLE  pXmlEle, BOOL  bRead  );
};
...
struct __declspec(uuid("7d39fcec-7410-45b5-87be-d4952e7e873c")) IDUIPropType : IDispatch
{
	...
	virtual HRESULT __stdcall raw_get_pVoid(long *pVal) = 0;
	virtual HRESULT __stdcall raw_put_pVoid(long pVal) = 0;
...
struct __declspec(uuid("8425da30-24dd-43c2-b0c9-5ef2bf80929a")) IDUIPropBase : IDispatch
{
	...
	BOOL  AccessConfig(OLE_HANDLE  pXmlEle, CString  strKeyName, BOOL  bRead, BOOL  bCompleteUseKey  );
	void SetDUIRes(struct IDUIRes * pDUIRes  );
	struct IDUIRes * GetDUIRes();
	void SetPrivateValue(VARIANT * variant  );
	void Clone(struct IDUIPropBase * pSrcProp  );
	BOOL  ExportConfig(OLE_HANDLE  pXmlEle, CString  strKeyName  );
	void DoCallbackFunc();
...
struct __declspec(uuid("9b840c4f-b2e8-46a7-9d04-8f0571adec3a")) IDUIWindow : IDispatch
{
	...
	virtual HRESULT __stdcall raw_SendMessage(OLE_HANDLE hWnd, long nMsgID, long wParam, long lParam, long *pResult) = 0;
	virtual HRESULT __stdcall raw_PostMessage(OLE_HANDLE hWnd, long nMsgID, long wParam, long lParam, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_RedrawWindow(OLE_HANDLE hWnd, struct SkinRect sknrcUpdate, long hrgnUpdate, short nFlags, VARIANT_BOOL *pResult) = 0;
	...
	long  SendMessage(OLE_HANDLE  hWnd, long  nMsgID, long  wParam, long  lParam  );
	BOOL  PostMessage(OLE_HANDLE  hWnd, long  nMsgID, long  wParam, long  lParam  );
	...
	OLE_HANDLE  Create(long  dwExStyle, CString  strClassName, CString  strWindowName, long  dwStyle, short  x, short  y, short  nWidth, short  nHeight, OLE_HANDLE  hWndParent  );
	...
	BOOL  SetWindowText(OLE_HANDLE  hWnd, CString  strString  );
	CString  GetWindowText(OLE_HANDLE  hWnd  );
	...
	BOOL  RedrawWindow(OLE_HANDLE  hWnd, struct SkinRect  sknrcUpdate, long  hrgnUpdate, short  nFlags  );
	...
	short  MessageBox(OLE_HANDLE  hWnd, CString  strText, CString  strCaption, long  lFlags  );
};
...
struct __declspec(uuid("600b0bdd-2ece-4e36-a349-456c7be9440f")) IDirectUI : ISkinObjResBase
{
	...
	//Method
	//
	virtual HRESULT __stdcall raw_Create(long hWndParent, struct SkinRect sknrc, VARIANT_BOOL *pResult) = 0;
	...
	virtual HRESULT __stdcall raw_DoWindowProc(OLE_HANDLE hWnd, long msg, long wParam, long lParam, long *pResult) = 0;
	...
	//Method Wrapper
	//
	BOOL  Create(long  hWndParent, struct SkinRect  sknrc  );
	...
	long  DoWindowProc(OLE_HANDLE  hWnd, long  msg, long  wParam, long  lParam  );
	long  Default();
	...
	BOOL  RemoveNCRgn(enum DUI_NCRGNTYPE  eNcRgnType, CString  strName  );
...
struct __declspec(uuid("c865ecaf-cb66-491d-8112-e42dfcc532cc")) _IDUIEventsEvents : IDispatch
{
	...
	//Method
	//
	virtual HRESULT __stdcall raw_OnLoaded(VARIANT_BOOL bSuccessed, HRESULT *pResult) = 0;
	virtual HRESULT __stdcall raw_OnWinMsg(unsigned long uMsgID, struct IDUIObj *pDUIObj, HRESULT *pResult) = 0;

	//
	//Method Wrapper
	//
	HRESULT  OnLoaded(BOOL  bSuccessed  );
	HRESULT  OnWinMsg(unsigned long  uMsgID, struct IDUIObj * pDUIObj  );
};
...
struct __declspec(uuid("aadcc987-5067-44ea-a536-4df0ef31e2f3")) ITextStyleProp : IDUIPropBase
{
	...
	OLE_HANDLE  GetBitmap(struct SkinRect  rect, CString  strText  );
	BOOL  Draw(OLE_HANDLE  hDC, struct SkinRect  rect, CString  strText  );
...
struct __declspec(uuid("4ca4d223-a97e-45d7-9e03-c16fdaed3f22")) IComboProp : IDUIPropBase
{
	...
	//Method Wrapper
	//
	void AddOption(CString  strOption  );
...
struct __declspec(uuid("149ee2b8-081d-45f7-bdd7-eae215b6f579")) IDUIMsgNotify : IDispatch
{
	...
	virtual HRESULT __stdcall raw_get_lParam1(long *pVal) = 0;
	virtual HRESULT __stdcall raw_put_lParam1(long pVal) = 0;
	virtual HRESULT __stdcall raw_get_lParam2(long *pVal) = 0;
	virtual HRESULT __stdcall raw_put_lParam2(long pVal) = 0;
	virtual HRESULT __stdcall raw_get_lParam3(long *pVal) = 0;
	virtual HRESULT __stdcall raw_put_lParam3(long pVal) = 0;
	virtual HRESULT __stdcall raw_get_lParam4(long *pVal) = 0;
	virtual HRESULT __stdcall raw_put_lParam4(long pVal) = 0;
	virtual HRESULT __stdcall raw_get_lParam5(long *pVal) = 0;
	virtual HRESULT __stdcall raw_put_lParam5(long pVal) = 0;
	...
	long  get_lParam1();
	void put_lParam1(long  pVal);
	long  get_lParam2();
	void put_lParam2(long  pVal);
	long  get_lParam3();
	void put_lParam3(long  pVal);
	long  get_lParam4();
	void put_lParam4(long  pVal);
	long  get_lParam5();
	void put_lParam5(long  pVal);
...
struct __declspec(uuid("c499116a-deb3-4cd7-9e88-a8544eb1fa09")) IDUISkinRgn : ISkinShareBase
{
	...
	//Method Wrapper
	//
	struct IDUISkinSubRgn * AddSubRgn(CString  strName  );
	struct IDUISkinSubRgn * GetSubRgn(CString  strName  );
	BOOL  RemoveSubRgn(CString  strName  );
	short  GetSubRgnCount();
};


#include "DirectUICom.tli"
#endif //__HEAD__DIRECTUICOM__