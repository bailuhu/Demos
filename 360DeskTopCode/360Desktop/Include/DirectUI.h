...
struct __declspec(uuid("d0ab9acc-2c46-4198-a091-54e117e9677c")) ISkinShareBase : IDUIObj
{
	...
	BOOL  AccessConfig2(OLE_HANDLE  pXmlEle, tstring  strKeyName, BOOL  bRead, BOOL  bCompleteUseKey  );
...
struct __declspec(uuid("f0a6b880-d1d3-4f9e-9e06-ba340130a26d")) IDUIRes : IDispatch
{
	...
	virtual HRESULT __stdcall raw_CallScripEvent(BSTR strGuid, long nMsgID, OLE_HANDLE wParam, OLE_HANDLE lParam, VARIANT_BOOL *pResult) = 0;
	...
	BOOL  CallScripEvent(tstring  strGuid, long  nMsgID, OLE_HANDLE  wParam, OLE_HANDLE  lParam  );
};
...
struct __declspec(uuid("118c0877-b832-4c18-bfbf-7a112483b6af")) IDUITextStyle : ISkinShareBase
{
	...
	BOOL  DrawText(OLE_HANDLE  hDC, tstring  strText, struct SkinRect  rect, BOOL  bCalcDraw, long  nUserFormat, struct SkinRect * pRectCalc  );
	long  GetDrawFlags();
...
struct __declspec(uuid("b143f497-cdec-4a2f-b903-530228d4bdb1")) IDUIControlBase : ISkinObjResBase
{
	...
	OLE_HANDLE  CreateObj(OLE_HANDLE  pSkinResource, OLE_HANDLE  pObjParent, long  ntype, BOOL  bInsertFirst  );
	...
	struct IDUIPropBase * CreateProp(struct ICtrlPluginProp * pPropParent, enum enumPropType  eType, tstring  strPropName, tstring  strPropHelp, BOOL  bIsStyle, struct IPropChangedCallback * pCallback  );
	BOOL  ExportConfig(OLE_HANDLE  pXmlEle  );
...
struct __declspec(uuid("79811451-25bd-4717-8739-c1055edbc9aa")) IScriptUtils : IDispatch
{
	...
	virtual HRESULT __stdcall raw_CallEventAll(OLE_HANDLE hScriptObject, long nMsgID, OLE_HANDLE wParam, OLE_HANDLE lParam, VARIANT_BOOL *pResult) = 0;
	virtual HRESULT __stdcall raw_CallEventSingle(OLE_HANDLE hScriptObject, BSTR strGuid, long nMsgID, OLE_HANDLE wParam, OLE_HANDLE lParam, VARIANT_BOOL *pResult) = 0;
	...
	BOOL  IsTemp();
	BOOL  CallEventAll(OLE_HANDLE  hScriptObject, long  nMsgID, OLE_HANDLE  wParam, OLE_HANDLE  lParam  );
	BOOL  CallEventSingle(OLE_HANDLE  hScriptObject, tstring  strGuid, long  nMsgID, OLE_HANDLE  wParam, OLE_HANDLE  lParam  );
};
