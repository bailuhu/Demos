...
// 	cv::Mat image2;
// 
// 	image1= cv::imread(JPG_boldt);
// 	image2= cv::imread(JPG_rain);
// 	if (!image1.data)
// 		return 0; 
// 	if (!image2.data)
// 		return 0; 
...
// 
// 	// read images
// 	cv::Mat image= cv::imread(JPG_boldt);
// 	cv::Mat logo= cv::imread(BMP_logo);
// 
// 	// define image ROI
// 	cv::Mat imageROI;
...
// 
// 	// read images
// 	image= cv::imread(JPG_boldt);
// 	logo= cv::imread(BMP_logo);
// 
// 	// define ROI
// 	imageROI= image(cv::Rect(385,270,logo.cols,logo.rows));
// 
// 	// load the mask (must be gray-level)
// 	cv::Mat mask= cv::imread(BMP_logo,0);
// 
